...
To stream and compress video in an Android application the FFmpeg project is needed to be included into the application. The FFmpeg project is a good choice because it has all the functionalities that are needed for this type of streaming service. Unfortunately the FFmpeg isn't that easy to impl
