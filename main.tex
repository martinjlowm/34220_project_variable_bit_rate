...
\SectionII{Introduction (s124320)}{Introduction}
\SectionII{Theory (s124320)}{Theory}
\Section{Implementation}
\Section{Evaluation}
\newpage
\SectionII{Conclusion (s124324)}{Conclusion}

\begin{Appendix}{python streamer\_server.py (s124324)}
    \inputminted[
        frame=lines,
        framesep=2mm,
        baselinestretch=1.2,
        ...
        linenos
    ]{python}{Python/raw/streamer_server.py}
\end{Appendix}

\begin{Appendix}{python streamer\_client.py (s124324)}
    \inputminted[
        frame=lines,
        framesep=2mm,
        baselinestretch=1.2,
        fontsize=\footnotesize,
        linenos
    ]{python}{Python/raw/streamer_client.py}
\end{Appendix}

\begin{Appendix}{android MainActivity.java (s103208)}
    \inputminted[
        frame=lines,
        framesep=2mm,
        baselinestretch=1.2,
        fontsize=\footnotesize,
        linenos
    ]{java}{android/DroneStreamer/app/src/main/java/dk/dtu/dronestreamer/MainActivity.java}
\end{Appendix}

\begin{Appendix}{android UDPsender.java (s103208)}
    \inputminted[
        frame=lines,
        framesep=2mm,
        baselinestretch=1.2,
        fontsize=\footnotesize,
        linenos
    ]{java}{android/DroneStreamer/app/src/main/java/dk/dtu/dronestreamer/UDPsender.java}
\end{Appendix}
